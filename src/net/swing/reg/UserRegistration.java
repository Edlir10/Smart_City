...
public class UserRegistration extends JFrame {
    ...
    public UserRegistration() {
        ...
        getContentPane().setBackground(new Color(218, 239, 243));
        ...
        btnNewButton.addActionListener(new ActionListener() 
        {
			...
			public void actionPerformed(ActionEvent e) 
            {
                ...
                if (len != 10) 
                {
                    JOptionPane.showMessageDialog(btnNewButton, "Are you sure you want to create the account?");
                }
                ...
                int a = JOptionPane.showConfirmDialog(btnNewButton, "You are registred, do you want to login now?");
